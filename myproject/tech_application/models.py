...
class TechApplication(models.Model):
    ...
    jxhcd = models.CharField(max_length=100, verbose_name="机械化程度")  # 总体机械化
    sdjxhcd = models.CharField(max_length=100, verbose_name="水稻机械化程度")
    sdjscd = models.CharField(max_length=100, verbose_name="水稻收割机械化程度")
    ...
    jdjsmj = models.CharField(max_length=100, verbose_name="水稻机捕面积")
